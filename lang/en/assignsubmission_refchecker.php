...
$string['debuglog'] = 'Activity log';
$string['debuglog_help'] = 'Record everything the checker does to a file: the references extracted from each submission, every database consulted for each one, what each replied, every pause and stand-down, and where a reference was given up on.

Intended for diagnosing a specific problem, not for running permanently. **The log contains the text of students\' references, so it is personal data.** Turn it on, reproduce the problem, read the log, and turn it off again. Files are deleted automatically once they pass the retention period, whether or not logging is still enabled.';
$string['debuglogdelete'] = 'Delete all log files';
$string['debuglogdeleted'] = 'Deleted {$a} log file(s).';
$string['debuglogdisabled'] = 'Activity logging is currently switched off, so nothing new is being recorded. Existing files are listed below until they pass the retention period.';
$string['debuglogempty'] = 'There are no log files. Nothing has been recorded since logging was last enabled, or everything recorded has passed the retention period.';
$string['debugloglink'] = 'The activity log, when enabled, is written one file per hour and can be read at <a href="{$a}">Reference Checker activity log</a>.';
$string['debuglogretention'] = 'Activity log retention';
$string['debuglogretention_help'] = 'How long each hourly log file is kept before it is deleted automatically. Because the log contains students\' reference text, this cannot be set longer than 72 hours.';
$string['debuglogretention_hour'] = '1 hour';
$string['debuglogretention_hours'] = '{$a} hours';
$string['debuglogs'] = 'Reference Checker activity log';
$string['debuglogsize'] = 'Size';
$string['debuglogtime'] = 'Hour covered';
$string['debuglogview'] = 'View';
...
$string['error_pacerstalled'] = 'Checking stopped because no request could be sent to the reference databases. Check the minimum interval configured for each database.';
...
$string['issue_authors_none'] = 'None of the authors of the work that was found appear in this reference.';
$string['issue_doi'] = 'The DOI points to a different work.';
$string['issue_extraauthors'] = 'These names are not among the authors of the work that was found: {$a->names}. Check whether they belong in this reference.';
$string['issue_journal'] = 'You cited {$a->cited}, but the work that was found appeared in {$a->found}.';
$string['issue_journal_version'] = 'You cited {$a->cited}, but the version that was found appeared in {$a->found}. One of these is a preprint of the other.';
$string['issue_year'] = 'You cited {$a->cited}, but the work that was found was published in {$a->found}.';
$string['issue_year_future'] = 'The year you cited ({$a->cited}) is in the future.';
$string['issue_year_version'] = 'You cited {$a->cited}, but the version that was found was published in {$a->found}. This is usually a preprint and its published version.';
...
$string['notfound_detail'] = 'No matching record was found in any of the reference databases that were searched.';
$string['notfound_detail_degraded'] = 'These databases could not be consulted, so this result is less certain than usual: {$a->sources}.';
$string['notfound_detail_sources'] = 'No matching record was found in {$a->sources}.';
$string['notfound_detail_uncertain'] = 'Not all of the reference databases could be searched this time, so this result is less certain than usual.';
