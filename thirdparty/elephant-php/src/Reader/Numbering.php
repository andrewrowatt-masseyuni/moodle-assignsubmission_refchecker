...
final class Numbering
{
    ...
    public function __construct(
        private readonly array $abstractNumIdByNumId = [],
        private readonly array $levelsByAbstractNumId = [],
        private readonly array $numStyleLinkByAbstractNumId = [],
        private readonly array $levelsByParagraphStyleId = [],
        private readonly ?Styles $styles = null,
    ) {
    }
