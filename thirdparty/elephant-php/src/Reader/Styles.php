...
final class Styles
{
    ...
    public function __construct(
        private readonly array $paragraphStyles = [],
        private readonly array $characterStyles = [],
        private readonly array $tableStyles = [],
        private readonly array $numberingStyleNumIdByStyleId = [],
    ) {
    }
