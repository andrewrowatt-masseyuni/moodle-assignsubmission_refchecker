...
final class Matcher
{
    public function __construct(
        ...
        public readonly StyleNameMatch $styleNameMatch = StyleNameMatch::Equal,
        /** Set when the matcher is one of mammoth's run-property forms (b, i, u, strike, all-caps, small-caps). */
        public readonly ?RunProperty $runProperty = null,
        ...
        public readonly ?BreakType $breakType = null,
    ) {
    }
